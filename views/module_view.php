<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <?php
            $page_name_postfix = ($module_data['module_name']) ? ' | '.$module_data['module_name'] : '' ;
            ?>
            <div class="page-header">
                <h1><?php echo _('Module Information').$page_name_postfix; ?></h1>
            </div>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-primary">
                <div class="panel-heading"><?php echo _('Basic'); ?> <?php echo _('Module Information'); ?></div>
                    ...
                    <div class="row">
                        <div class="col-lg-7 col-md-offset-1">
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="col-sm-9">
                                    <?php echo $module_data['module_name']; ?>
                                </div>
                            </div>

                            <div class="form-group clearfix">
                                <label for="name" class="col-sm-3 control-label"><?php echo _('Url'); ?></label>
                                <div class="col-sm-9">
                                    <?php echo $module_data['module_url']; ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="col-sm-9">
                                    <?php echo display_datetime($module_data['insert_datetime']); ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="col-sm-9">
                                    <?php echo display_datetime($module_data['update_datetime']); ?>
                                </div>
                            </div>
