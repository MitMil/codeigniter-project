...
class Gettext {
    ...
    public function __construct($config = array()) {
        ...
        bindtextdomain( $config['gettext_text_domain'], APPPATH.$config['gettext_locale_dir'] );
        bind_textdomain_codeset( $config['gettext_text_domain'], 'UTF-8' );
        textdomain( $config['gettext_text_domain'] );
